...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe(self):
        ...
        payload={
            ...
            "time_minutes":6,
            "price":Decimal("3.2"),
            "description":"Sample of new recipe",
    ...
    def test_create_recipe_with_existing_tags(self):
        ...
        tag_inadian=Tag.objects.create(user=self.user,name="Indian")
        payload={
            "title":"Pongal",
            "time_minutes":60,
            "price":Decimal("4.50"),
        ...
        recipe=recipes[0]
        self.assertEqual(recipe.tags.count(),2)
        self.assertIn(tag_inadian,recipe.tags.all())
        for tag in payload["tags"]:
            exists=recipe.tags.filter(
                name=tag["name"],
                user=self.user
